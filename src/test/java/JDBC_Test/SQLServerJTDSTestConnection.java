...
public class SQLServerJTDSTestConnection {
    ...
    public static void main(String[] args) throws SQLException, ClassNotFoundException {
        ...
        String sql = "UPDATE [dbo].[UserSubmitTime]\n" +
                "SET ExpireDate = '2024-03-25 00:00:00.0000000'\n" +
                "WHERE Id in (SELECT TOP(1) Id FROM [dbo].[UserSubmitTime] ORDER BY CreatedOnDate DESC);";
